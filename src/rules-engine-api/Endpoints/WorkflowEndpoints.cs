...
public static class WorkflowEndpoints
{
    public static IEndpointRouteBuilder MapWorkflowEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        app.MapGet("/workflows", [Authorize] (HttpContext context, [FromQuery] string? workflowName, [FromServices] IWorkflowRepository repository, [AsParameters] PaginationQuery query, CancellationToken ct) =>
        {
