...
public static class WorkflowEndpoints
{
    public static IEndpointRouteBuilder MapWorkflowEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        app.MapGet("/workflows", async (HttpContext context, [FromQuery] string? workflowName, [FromServices] IWorkflowRepository repository, [AsParameters] PaginationQuery query, CancellationToken ct) =>
        {
